...
Source0  : https://files.pythonhosted.org/packages/b4/c2/c9094283a07dd96c5a8f7a5f1910259d40d2e29223b95dd875a6ca13b58f/hatch_fancy_pypi_readme-24.1.0.tar.gz
...
%prep
%setup -q -n hatch_fancy_pypi_readme-24.1.0
cd %{_builddir}/hatch_fancy_pypi_readme-24.1.0
pushd ..
cp -a hatch_fancy_pypi_readme-24.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704140453
